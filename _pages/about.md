...
* **Trustworthy AI & AI Safety**: Using interpretability methods, discover security vulnerabilities in AI systems, including foundation model and AI agents, and develop corresponding defense and detection algorithms, including safety alignment strategies.
...
I welcome collaboration opportunities. Please feel free to contact me at *luo.1455@osu.edu* or *luo.1455@uga.edu*.
...
- *2024.07.09*🎉, Our paper *JailBreakV-28K: A Benchmark for Assessing the Robustness of MultiModal Large Language Models against Jailbreak Attacks* has been accepted by **COLM'2024** (Poster). I served as the **first author**. Thanks to my collaborators.
